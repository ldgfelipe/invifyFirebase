...
export const TEMPLATES = [
  ...
  },
  {
    ...
    builderConfig: baseBuilder({
      ...
      modules: [
        ...
        { id: "hdr", type: "header", visible: true, title: "Amor bohemio", names: "Sofía & Martín", date: "2026-10-03T17:00:00", subtitle: "Bajo el atardecer, di sí con nosotros", imageUrl: "https://loremflickr.com/800/600/wedding?lock=1" },
        ...
        { id: "ca", type: "carousel", visible: true, images: [{ url: "https://loremflickr.com/800/600/wedding?lock=2" }, { url: "https://loremflickr.com/800/600/wedding?lock=3" }] },
        { id: "lc", type: "location", visible: true, venue: "Playa del Cielo, Tulum", address: "Tulum, Quintana Roo", lat: 20.211, lng: -87.465, mapUrl: "" },
        { id: "dc", type: "dresscode", visible: true, code: "Boho Chic", description: "Lino, flores y pies descalzos.", imageUrl: "https://loremflickr.com/800/600/wedding?lock=4" },
  ...
  },
  {
    ...
    previewUrl: "https://loremflickr.com/800/600/wedding?lock=6",
    active: true,
    ...
    builderConfig: baseBuilder({
      ...
      modules: [
        ...
        { id: "hdr", type: "header", visible: true, title: "Minimal love", names: "María & Jorge", date: "2026-09-20T18:00:00", subtitle: "Menos es más", imageUrl: "https://loremflickr.com/800/600/wedding?lock=7" },
  ...
  },
  {
    ...
    category: "boda",
    thumbnailUrl: "https://loremflickr.com/800/600/wedding?lock=8",
    previewUrl: "https://loremflickr.com/800/600/wedding?lock=9",
    active: true,
    createdAt: Date.now() + 3,
    builderConfig: baseBuilder({
      primaryColor: "#7BA17D", background: "#F0F7F0", fontFamily: "serif",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "Jardín de amor", names: "Valeria & Andrés", date: "2026-05-17T15:30:00", subtitle: "Entre flores y promesas", imageUrl: "https://loremflickr.com/800/600/wedding?lock=10" },
        { id: "cd", type: "countdown", visible: true, targetDate: "2026-05-17T15:30:00", label: "Florece nuestro día" },
        { id: "ca", type: "carousel", visible: true, images: [{ url: "https://loremflickr.com/800/600/wedding?lock=11" }, { url: "https://images.unsplash.com/photo-1519225421980-715cb0215aed?w=800&q=80" }] },
  ...
  // ==================== CUMPLEAÑOS (6) ====================
  {
    ...
    previewUrl: "https://loremflickr.com/800/600/birthday?lock=2",
    active: true,
    createdAt: Date.now() + 10,
    builderConfig: baseBuilder({
      primaryColor: "#FF2E93", background: "#120012", fontFamily: "sans",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "¡Fiesta Neon!", names: "¡Cumple de Sofi - 25!", date: "2026-07-12T21:00:00", subtitle: "Brilla con nosotros", imageUrl: "https://loremflickr.com/800/600/birthday?lock=3" },
  ...
  },
  {
    ...
    category: "cumpleanos",
    thumbnailUrl: "https://loremflickr.com/800/600/birthday?lock=4",
    previewUrl: "https://loremflickr.com/800/600/birthday?lock=5",
    active: true,
    createdAt: Date.now() + 11,
    builderConfig: baseBuilder({
      primaryColor: "#77C687", background: "#FFF9E6", fontFamily: "sans",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "¡Fiesta en el jardín!", names: "Mateo cumple 5", date: "2026-04-18T15:00:00", subtitle: "Dinosaurios y pastel", imageUrl: "https://loremflickr.com/800/600/birthday?lock=6" },
        { id: "cd", type: "countdown", visible: true, targetDate: "2026-04-18T15:00:00", label: "Cuenta regresiva dino" },
        { id: "ca", type: "carousel", visible: true, images: [{ url: "https://loremflickr.com/800/600/birthday?lock=7" }] },
  ...
  },
  {
    ...
    category: "cumpleanos",
    thumbnailUrl: "https://loremflickr.com/800/600/birthday?lock=8",
    previewUrl: "https://loremflickr.com/800/600/birthday?lock=9",
    active: true,
    createdAt: Date.now() + 12,
    builderConfig: baseBuilder({
      primaryColor: "#3A2D4A", background: "#F5F0FF", fontFamily: "serif",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "Noche elegante", names: "40 años de Claudia", date: "2026-09-05T20:00:00", subtitle: "Cóctel & jazz", imageUrl: "https://loremflickr.com/800/600/birthday?lock=10" },
  ...
  },
  {
    ...
    category: "cumpleanos",
    thumbnailUrl: "https://loremflickr.com/800/600/birthday?lock=11",
    previewUrl: "https://loremflickr.com/800/600/birthday?lock=12",
    active: true,
    createdAt: Date.now() + 14,
    builderConfig: baseBuilder({
      primaryColor: "#8B4513", background: "#FFF8DC", fontFamily: "serif",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "Retro 50's", names: "¡50 de Roberto!", date: "2026-08-15T19:30:00", subtitle: "Vinilos y rock & roll", imageUrl: "https://loremflickr.com/800/600/birthday?lock=13" },
  ...
  },
  {
    ...
    category: "cumpleanos",
    thumbnailUrl: "https://loremflickr.com/800/600/birthday?lock=14",
    previewUrl: "https://loremflickr.com/800/600/birthday?lock=15",
    active: true,
    createdAt: Date.now() + 15,
    builderConfig: baseBuilder({
      primaryColor: "#C0A030", background: "#FFFDF0", fontFamily: "serif",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "Glam Night", names: "¡30 de Valentina!", date: "2026-11-22T21:00:00", subtitle: "Brillo, glam y champagne", imageUrl: "https://loremflickr.com/800/600/birthday?lock=16" },
  ...
  // ==================== BABYSHOWER (6) ====================
  {
    ...
    previewUrl: "https://loremflickr.com/800/600/baby?lock=2",
    active: true,
    createdAt: Date.now() + 20,
    builderConfig: baseBuilder({
      primaryColor: "#8ECAE6", background: "#F0FAFF", fontFamily: "serif",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "¡Bebé en camino!", names: "Esperando a Emma", date: "2026-06-14T16:00:00", subtitle: "Lluvia de amor entre nubes", imageUrl: "https://loremflickr.com/800/600/baby?lock=3" },
        ...
        { id: "ca", type: "carousel", visible: true, images: [{ url: "https://loremflickr.com/800/600/baby?lock=4" }] },
  ...
  },
  {
    ...
    category: "babyshower",
    thumbnailUrl: "https://loremflickr.com/800/600/baby?lock=5",
    previewUrl: "https://loremflickr.com/800/600/baby?lock=6",
    active: true,
    createdAt: Date.now() + 22,
    builderConfig: baseBuilder({
      primaryColor: "#9CA3AF", background: "#F9FAFB", fontFamily: "serif",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "Pequeño elefantito", names: "Babyshower de Noah", date: "2026-05-30T16:30:00", subtitle: "Grandes sueños, pequeño corazón", imageUrl: "https://loremflickr.com/800/600/baby?lock=7" },
  ...
  },
  {
    ...
    category: "babyshower",
    thumbnailUrl: "https://loremflickr.com/800/600/baby?lock=8",
    previewUrl: "https://loremflickr.com/800/600/baby?lock=9",
    active: true,
    createdAt: Date.now() + 23,
    builderConfig: baseBuilder({
      primaryColor: "#F4A7B9", background: "#FFF0F5", fontFamily: "sans",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "Arcoíris de amor", names: "¡Hola Mía!", date: "2026-08-12T17:00:00", subtitle: "Colores y dulzura", imageUrl: "https://loremflickr.com/800/600/baby?lock=10" },
  ...
  },
  {
    ...
    previewUrl: "https://loremflickr.com/800/600/baby?lock=14",
    active: true,
    createdAt: Date.now() + 25,
    builderConfig: baseBuilder({
      primaryColor: "#E9A6B8", background: "#FFF5F8", fontFamily: "serif",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "Dulce espera", names: "Babyshower de Isabella", date: "2026-07-20T16:00:00", subtitle: "La princesa llega", imageUrl: "https://loremflickr.com/800/600/baby?lock=15" },
        ...
        { id: "ca", type: "carousel", visible: true, images: [{ url: "https://loremflickr.com/800/600/baby?lock=16" }] },
        { id: "rs", type: "rsvp", visible: true, title: "Confirma", collectEmail: true },
      ],
    }),
  },
  // ==================== BAUTIZO (6) ====================
  {
    ...
    previewUrl: "https://loremflickr.com/800/600/baptism?lock=2",
    active: true,
    createdAt: Date.now() + 30,
    builderConfig: baseBuilder({
      primaryColor: "#A8C0E0", background: "#F2F7FF", fontFamily: "serif",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "Bautizo celestial", names: "Ángel Gabriel", date: "2026-06-07T12:00:00", subtitle: "Dios te bendiga", imageUrl: "https://loremflickr.com/800/600/baptism?lock=3" },
  ...
  },
  {
    ...
    category: "bautizo",
    thumbnailUrl: "https://loremflickr.com/800/600/baptism?lock=4",
    previewUrl: "https://loremflickr.com/800/600/baptism?lock=5",
    active: true,
    createdAt: Date.now() + 31,
    builderConfig: baseBuilder({
      primaryColor: "#D4C5B0", background: "#FFFEFB", fontFamily: "serif",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "Mi Bautizo", names: "Sofía Victoria", date: "2026-07-11T11:00:00", subtitle: "Con fé y amor", imageUrl: "https://loremflickr.com/800/600/baptism?lock=6" },
  ...
  },
  {
    ...
    category: "bautizo",
    thumbnailUrl: "https://loremflickr.com/800/600/baptism?lock=7",
    previewUrl: "https://loremflickr.com/800/600/baptism?lock=8",
    active: true,
    createdAt: Date.now() + 33,
    builderConfig: baseBuilder({
      primaryColor: "#6C5B7B", background: "#F8F5FF", fontFamily: "serif",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "Mi Principito", names: "Bautizo de Leo", date: "2026-05-16T12:00:00", subtitle: "Corona y amor", imageUrl: "https://loremflickr.com/800/600/baptism?lock=9" },
  ...
  },
  {
    ...
    previewUrl: "https://loremflickr.com/800/600/baptism?lock=11",
    active: true,
    createdAt: Date.now() + 34,
    builderConfig: baseBuilder({
      primaryColor: "#F9D56E", background: "#FFFEF0", fontFamily: "serif",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "Luz divina", names: "Bautizo de Alana", date: "2026-09-20T11:30:00", subtitle: "Que tu luz brille", imageUrl: "https://loremflickr.com/800/600/baptism?lock=12" },
  ...
  // ==================== CORPORATIVO (6) ====================
  {
    ...
    previewUrl: "https://loremflickr.com/800/600/corporate?lock=2",
    active: true,
    createdAt: Date.now() + 40,
    builderConfig: baseBuilder({
      primaryColor: "#2563EB", background: "#F0F6FF", fontFamily: "sans",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "Tech Summit 2026", names: "Invitación Corporativa", date: "2026-10-22T09:00:00", subtitle: "Innovación sin límites", imageUrl: "https://loremflickr.com/800/600/corporate?lock=3" },
        ...
        { id: "ca", type: "carousel", visible: true, images: [{ url: "https://loremflickr.com/800/600/corporate?lock=4" }] },
  ...
  },
  {
    ...
    previewUrl: "https://loremflickr.com/800/600/corporate?lock=6",
    active: true,
    createdAt: Date.now() + 41,
    builderConfig: baseBuilder({
      primaryColor: "#0F172A", background: "#F8FAFC", fontFamily: "serif",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "Gala Anual", names: "Premios Empresariales 2026", date: "2026-11-28T20:00:00", subtitle: "Celebrando la excelencia", imageUrl: "https://loremflickr.com/800/600/corporate?lock=7" },
  ...
  },
  {
    ...
    previewUrl: "https://loremflickr.com/800/600/corporate?lock=9",
    active: true,
    createdAt: Date.now() + 42,
    builderConfig: baseBuilder({
      primaryColor: "#9333EA", background: "#FAF5FF", fontFamily: "sans",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "¡Nuevo lanzamiento!", names: "Producto X - Reveal", date: "2026-09-10T18:30:00", subtitle: "El futuro es ahora", imageUrl: "https://loremflickr.com/800/600/corporate?lock=10" },
        { id: "cd", type: "countdown", visible: true, targetDate: "2026-09-10T18:30:00", label: "Reveal" },
        { id: "ca", type: "carousel", visible: true, images: [{ url: "https://loremflickr.com/800/600/corporate?lock=11" }] },
  ...
  },
  {
    ...
    previewUrl: "https://loremflickr.com/800/600/corporate?lock=13",
    active: true,
    createdAt: Date.now() + 43,
    builderConfig: baseBuilder({
      primaryColor: "#059669", background: "#ECFDF5", fontFamily: "sans",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "Networking Cocktail", names: "Conecta & Crece", date: "2026-08-20T18:00:00", subtitle: "Cóctel ejecutivo", imageUrl: "https://loremflickr.com/800/600/corporate?lock=14" },
  ...
  },
  {
    ...
    category: "corporativo",
    thumbnailUrl: "https://loremflickr.com/800/600/corporate?lock=15",
    previewUrl: "https://loremflickr.com/800/600/corporate?lock=16",
    active: true,
    createdAt: Date.now() + 44,
    builderConfig: baseBuilder({
      primaryColor: "#334155", background: "#F1F5F9", fontFamily: "serif",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "Reunión Anual", names: "Grupo Invify 2026", date: "2026-12-12T10:00:00", subtitle: "Resultados y visión 2027", imageUrl: "https://loremflickr.com/800/600/corporate?lock=17" },
  ...
  },
  {
    ...
    category: "corporativo",
    thumbnailUrl: "https://loremflickr.com/800/600/corporate?lock=18",
    previewUrl: "https://loremflickr.com/800/600/corporate?lock=19",
    active: true,
    createdAt: Date.now() + 45,
    builderConfig: baseBuilder({
      primaryColor: "#F97316", background: "#FFF7ED", fontFamily: "sans",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "Startup Pitch Night", names: "Invify Demo Day", date: "2026-07-30T18:00:00", subtitle: "Ideas que cambian el mundo", imageUrl: "https://loremflickr.com/800/600/corporate?lock=20" },
        { id: "cd", type: "countdown", visible: true, targetDate: "2026-07-30T18:00:00", label: "Demo Day" },
        { id: "ca", type: "carousel", visible: true, images: [{ url: "https://loremflickr.com/800/600/corporate?lock=21" }] },
