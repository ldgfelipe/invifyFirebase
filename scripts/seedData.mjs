...
export const TEMPLATES = [
  // ==================== BODA - 6 profesionales ====================
  {
    ...
    category: "boda",
    thumbnailUrl: "https://loremflickr.com/800/600/wedding?lock=1",
    previewUrl: "https://loremflickr.com/1200/800/wedding?lock=1",
    active: true,
    createdAt: Date.now(),
    builderConfig: baseBuilder({
      primaryColor: "#8B6A2B", background: "#FFFBF2", fontFamily: "serif",
      modules: [
        { id: "pre", type: "preloader", visible: true, text: "A & L", imageUrl: "https://loremflickr.com/400/400/wedding?lock=101" },
        { id: "hdr", type: "header", visible: true, title: "Nos casamos", names: "Ana & Luis — 14.11.2026", date: "2026-11-14T16:00:00", subtitle: "Ceremonia íntima, celebración eterna", imageUrl: "https://loremflickr.com/1200/800/wedding?lock=2", style: { backgroundImage: "https://loremflickr.com/1200/800/wedding?lock=2", backgroundOverlay: "rgba(255,251,242,0.72)", textColor: "#2C2C2C", padding: "56px 20px", borderRadius: "20px" } },
        ...
        { id: "ca", type: "carousel", visible: true, images: [{ url: "https://loremflickr.com/800/600/wedding?lock=3" }, { url: "https://loremflickr.com/800/600/wedding?lock=4" }] },
  ...
  },
  {
    ...
    category: "boda",
    thumbnailUrl: "https://loremflickr.com/800/600/wedding?lock=5",
    previewUrl: "https://loremflickr.com/1200/800/wedding?lock=5",
    active: true,
    createdAt: Date.now() + 1,
    builderConfig: baseBuilder({
      primaryColor: "#111111", background: "#F7F7F7", fontFamily: "sans", textColor: "#111111",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "M & J", names: "María & Jorge", date: "2026-09-20T18:00:00", subtitle: "Menos es más", imageUrl: "https://loremflickr.com/800/600/wedding?lock=6", style: { background: "#FFFFFF", textColor: "#111111", padding: "40px 20px", borderRadius: "0px", border: "1px solid #E5E5E5" } },
  ...
  },
  {
    ...
    category: "boda",
    thumbnailUrl: "https://loremflickr.com/800/600/wedding?lock=7",
    previewUrl: "https://loremflickr.com/1200/800/wedding?lock=7",
    active: true,
    createdAt: Date.now() + 2,
    builderConfig: baseBuilder({
      primaryColor: "#C2704A", background: "#FFF5EF", fontFamily: "serif",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "Amor bohemio", names: "Sofía & Martín — Atardecer en Tulum", date: "2026-10-03T17:00:00", subtitle: "Pies descalzos, corazón lleno", imageUrl: "https://loremflickr.com/800/600/wedding?lock=8", style: { backgroundImage: "https://loremflickr.com/800/600/wedding?lock=8", backgroundOverlay: "rgba(255,245,239,0.68)", padding: "48px 20px", borderRadius: "24px" } },
        { id: "cd", type: "countdown", visible: true, targetDate: "2026-10-03T17:00:00", label: "Atardecer" },
        { id: "ca", type: "carousel", visible: true, images: [{ url: "https://loremflickr.com/800/600/wedding?lock=9" }, { url: "https://loremflickr.com/800/600/wedding?lock=10" }] },
  ...
  },
  {
    ...
    category: "boda",
    thumbnailUrl: "https://loremflickr.com/800/600/wedding?lock=11",
    previewUrl: "https://loremflickr.com/1200/800/wedding?lock=11",
    active: true,
    createdAt: Date.now() + 3,
    builderConfig: baseBuilder({
      primaryColor: "#4A6B5A", background: "#F0F7F0", fontFamily: "serif",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "Jardín de amor", names: "Valeria & Andrés", date: "2026-05-17T15:30:00", subtitle: "Entre flores y promesas", imageUrl: "https://loremflickr.com/800/600/wedding?lock=12" },
        ...
        { id: "ca", type: "carousel", visible: true, images: [{ url: "https://loremflickr.com/800/600/wedding?lock=13" }, { url: "https://loremflickr.com/800/600/wedding?lock=14" }] },
        { id: "tx", type: "text", visible: true, title: "Mensaje especial", content: "<p>Escribe tu mensaje especial aquí. Este bloque queda exactamente donde lo dejes — arrástralo en el editor para reordenar.</p>", align: "center" },
        { id: "rs", type: "rsvp", visible: true, title: "Confirma tu asistencia", collectEmail: true },
      ],
    }),
  },
  {
    ...
    category: "boda",
    thumbnailUrl: "https://loremflickr.com/800/600/wedding?lock=15",
    previewUrl: "https://loremflickr.com/1200/800/wedding?lock=15",
    active: true,
    createdAt: Date.now() + 4,
    builderConfig: baseBuilder({
      primaryColor: "#D4AF37", background: "#0F0F1E", backgroundImage: "https://loremflickr.com/1920/1080/wedding?lock=100", backgroundOverlay: "rgba(15,15,30,0.72)", textColor: "#FFFFFF", fontFamily: "serif",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "Bajo las estrellas", names: "Luna & Diego", date: "2026-08-08T20:00:00", subtitle: "Gala nocturna, luz eterna", imageUrl: "https://loremflickr.com/800/600/wedding?lock=16", style: { background: "rgba(255,255,255,0.06)", textColor: "#FFFFFF", padding: "48px 20px", borderRadius: "16px", border: "1px solid rgba(255,255,255,0.12)" } },
  ...
  },
  {
    ...
    category: "boda",
    thumbnailUrl: "https://loremflickr.com/800/600/wedding?lock=17",
    previewUrl: "https://loremflickr.com/1200/800/wedding?lock=17",
    active: true,
    createdAt: Date.now() + 5,
    builderConfig: baseBuilder({
      primaryColor: "#0E8A7A", background: "#F0FFFA", fontFamily: "sans",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "Destino: Amor", names: "Camila & Jorge — Playa del Carmen", date: "2026-06-21T17:30:00", subtitle: "Arena, mar y sí quiero", imageUrl: "https://loremflickr.com/800/600/wedding?lock=18", style: { backgroundImage: "https://loremflickr.com/800/600/wedding?lock=18", backgroundOverlay: "rgba(240,255,250,0.72)", padding: "52px 20px", borderRadius: "20px" } },
  ...
  // ==================== CUMPLEAÑOS - 6 profesionales ====================
  {
    ...
    category: "cumpleanos",
    thumbnailUrl: "https://loremflickr.com/800/600/birthday?lock=1",
    previewUrl: "https://loremflickr.com/1200/800/birthday?lock=1",
    active: true,
    createdAt: Date.now() + 10,
    builderConfig: baseBuilder({
      primaryColor: "#FF6B6B", background: "#FFF9E6", fontFamily: "sans",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "¡Fiesta Arcoíris!", names: "Mateo cumple 5", date: "2026-04-18T15:00:00", subtitle: "Colores, pastel y piñata", imageUrl: "https://loremflickr.com/800/600/birthday?lock=2", style: { background: "linear-gradient(135deg,#FF6B6B,#FFD166)", textColor: "#FFFFFF", padding: "36px 20px", borderRadius: "20px" } },
        { id: "cd", type: "countdown", visible: true, targetDate: "2026-04-18T15:00:00", label: "Ya casi" },
        { id: "ca", type: "carousel", visible: true, images: [{ url: "https://loremflickr.com/800/600/birthday?lock=3" }, { url: "https://loremflickr.com/800/600/birthday?lock=4" }] },
  ...
  },
  {
    ...
    category: "cumpleanos",
    thumbnailUrl: "https://loremflickr.com/800/600/birthday?lock=5",
    previewUrl: "https://loremflickr.com/1200/800/birthday?lock=5",
    active: true,
    createdAt: Date.now() + 11,
    builderConfig: baseBuilder({
      primaryColor: "#FF2E93", background: "#0A0A0A", backgroundImage: "https://loremflickr.com/1920/1080/birthday?lock=50", backgroundOverlay: "rgba(0,0,0,0.6)", textColor: "#FFFFFF", fontFamily: "sans",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "NEON 25", names: "Sofi — Rooftop Party", date: "2026-07-12T21:00:00", subtitle: "Brilla, baila, celebra", imageUrl: "https://loremflickr.com/800/600/birthday?lock=6", style: { background: "rgba(255,46,147,0.12)", textColor: "#FFFFFF", border: "1px solid rgba(255,46,147,0.35)", padding: "32px 20px", borderRadius: "16px" } },
  ...
  },
  {
    ...
    category: "cumpleanos",
    thumbnailUrl: "https://loremflickr.com/800/600/birthday?lock=7",
    previewUrl: "https://loremflickr.com/1200/800/birthday?lock=7",
    active: true,
    createdAt: Date.now() + 12,
    builderConfig: baseBuilder({
      primaryColor: "#3A2D4A", background: "#F5F0FF", fontFamily: "serif",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "Noche elegante", names: "40 años de Claudia", date: "2026-09-05T20:00:00", subtitle: "Cóctel, jazz y gratitud", imageUrl: "https://loremflickr.com/800/600/birthday?lock=8", style: { background: "#FFFFFF", textColor: "#3A2D4A", padding: "48px 20px", borderRadius: "16px", border: "1px solid #E9E0FF" } },
  ...
  },
  {
    ...
    category: "cumpleanos",
    thumbnailUrl: "https://loremflickr.com/800/600/birthday?lock=9",
    previewUrl: "https://loremflickr.com/1200/800/birthday?lock=9",
    active: true,
    createdAt: Date.now() + 13,
    builderConfig: baseBuilder({
      primaryColor: "#0E9F6E", background: "#ECFDF5", fontFamily: "sans",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "¡Aloha 30!", names: "Tropical Dani", date: "2026-06-28T16:00:00", subtitle: "Palmeras, alberca y atardecer", imageUrl: "https://loremflickr.com/800/600/birthday?lock=10", style: { backgroundImage: "https://loremflickr.com/800/600/birthday?lock=10", backgroundOverlay: "rgba(236,253,245,0.72)", padding: "44px 20px", borderRadius: "20px" } },
        { id: "cd", type: "countdown", visible: true, targetDate: "2026-06-28T16:00:00", label: "Aloha" },
        { id: "ca", type: "carousel", visible: true, images: [{ url: "https://loremflickr.com/800/600/birthday?lock=11" }, { url: "https://loremflickr.com/800/600/birthday?lock=12" }] },
  ...
  },
  {
    ...
    category: "cumpleanos",
    thumbnailUrl: "https://loremflickr.com/800/600/birthday?lock=13",
    previewUrl: "https://loremflickr.com/1200/800/birthday?lock=13",
    active: true,
    createdAt: Date.now() + 14,
    builderConfig: baseBuilder({
      primaryColor: "#7C3A0A", background: "#FFF8DC", fontFamily: "serif",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "Vinyl 50", names: "¡50 de Roberto!", date: "2026-08-15T19:30:00", subtitle: "Rock, vinilos y amigos", imageUrl: "https://loremflickr.com/800/600/birthday?lock=14", style: { background: "#FFF8DC", textColor: "#7C3A0A", border: "2px dashed #E7C9A0", padding: "36px 20px", borderRadius: "12px" } },
  ...
  },
  {
    ...
    name: "Cumple Glam 30",
    category: "cumpleanos",
    thumbnailUrl: "https://loremflickr.com/800/600/birthday?lock=15",
    previewUrl: "https://loremflickr.com/1200/800/birthday?lock=15",
    active: true,
    createdAt: Date.now() + 15,
    builderConfig: baseBuilder({
      primaryColor: "#A68A00", background: "#FFFDF0", fontFamily: "serif",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "Glam Night", names: "Valentina — 30", date: "2026-11-22T21:00:00", subtitle: "Champagne, brillo y amigas", imageUrl: "https://loremflickr.com/800/600/birthday?lock=16", style: { background: "linear-gradient(135deg,#FFFDF0,#FFF2B2)", textColor: "#5A4A00", padding: "48px 20px", borderRadius: "24px", border: "1px solid #F5E6A0" } },
  ...
  // ==================== BABYSHOWER - 6 profesionales ====================
  {
    ...
    category: "babyshower",
    thumbnailUrl: "https://loremflickr.com/800/600/baby?lock=1",
    previewUrl: "https://loremflickr.com/1200/800/baby?lock=1",
    active: true,
    createdAt: Date.now() + 20,
    builderConfig: baseBuilder({
      primaryColor: "#6B8CAE", background: "#F0FAFF", fontFamily: "serif",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "Entre nubes", names: "Esperando a Emma", date: "2026-06-14T16:00:00", subtitle: "Suavidad, luz y amor", imageUrl: "https://loremflickr.com/800/600/baby?lock=2", style: { background: "#FFFFFF", textColor: "#4A5A73", padding: "40px 20px", borderRadius: "20px", border: "1px solid #E0EAF5" } },
        { id: "cd", type: "countdown", visible: true, targetDate: "2026-06-14T16:00:00", label: "Llega Emma" },
        { id: "gf", type: "giftTable", visible: true, items: [{ name: "Lista Amazon Baby", url: "https://amazon.com/baby", imageUrl: "https://loremflickr.com/200/200/baby?lock=20" }] },
  ...
  },
  {
    ...
    category: "babyshower",
    thumbnailUrl: "https://loremflickr.com/800/600/baby?lock=3",
    previewUrl: "https://loremflickr.com/1200/800/baby?lock=3",
    active: true,
    createdAt: Date.now() + 21,
    builderConfig: baseBuilder({
      primaryColor: "#2F6B3A", background: "#F3FFF0", fontFamily: "sans",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "Selva Baby", names: "León — Llega el rey", date: "2026-07-05T15:00:00", subtitle: "Hojas, aventura y ternura", imageUrl: "https://loremflickr.com/800/600/baby?lock=4", style: { backgroundImage: "https://loremflickr.com/800/600/baby?lock=4", backgroundOverlay: "rgba(243,255,240,0.78)", padding: "44px 20px", borderRadius: "16px" } },
        { id: "it", type: "itinerary", visible: true, items: [{ time: "15:00", title: "Bienvenida selva" }, { time: "16:30", title: "Juegos" }] },
        { id: "ca", type: "carousel", visible: true, images: [{ url: "https://loremflickr.com/800/600/baby?lock=5" }, { url: "https://loremflickr.com/800/600/baby?lock=6" }] },
  ...
  },
  {
    ...
    category: "babyshower",
    thumbnailUrl: "https://loremflickr.com/800/600/baby?lock=7",
    previewUrl: "https://loremflickr.com/1200/800/baby?lock=7",
    active: true,
    createdAt: Date.now() + 22,
    builderConfig: baseBuilder({
      primaryColor: "#7A7A8A", background: "#F9FAFB", fontFamily: "serif",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "Pequeño elefantito", names: "Noah — Dulce espera", date: "2026-05-30T16:30:00", subtitle: "Grandes sueños, corazón pequeño", imageUrl: "https://loremflickr.com/800/600/baby?lock=8", style: { background: "#FFFFFF", border: "2px solid #E5E7EB", padding: "36px 20px", borderRadius: "24px" } },
        { id: "cd", type: "countdown", visible: true, targetDate: "2026-05-30T16:30:00", label: "Llega Noah" },
        { id: "gf", type: "giftTable", visible: true, items: [{ name: "Mesa Elefantito", url: "", imageUrl: "https://loremflickr.com/200/200/baby?lock=21" }] },
  ...
  },
  {
    ...
    category: "babyshower",
    thumbnailUrl: "https://loremflickr.com/800/600/baby?lock=9",
    previewUrl: "https://loremflickr.com/1200/800/baby?lock=9",
    active: true,
    createdAt: Date.now() + 23,
    builderConfig: baseBuilder({
      primaryColor: "#E46A9A", background: "#FFF0F5", fontFamily: "sans",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "Arcoíris de amor", names: "¡Hola Mía!", date: "2026-08-12T17:00:00", subtitle: "Pastel, confeti y dulzura", imageUrl: "https://loremflickr.com/800/600/baby?lock=10", style: { background: "linear-gradient(135deg,#FFF0F5,#FFE4EC)", padding: "40px 20px", borderRadius: "20px" } },
        { id: "ca", type: "carousel", visible: true, images: [{ url: "https://loremflickr.com/800/600/baby?lock=11" }, { url: "https://loremflickr.com/800/600/baby?lock=12" }] },
  ...
  },
  {
    ...
    category: "babyshower",
    thumbnailUrl: "https://loremflickr.com/800/600/baby?lock=13",
    previewUrl: "https://loremflickr.com/1200/800/baby?lock=13",
    active: true,
    createdAt: Date.now() + 24,
    builderConfig: baseBuilder({
      primaryColor: "#5A6B4A", background: "#F5F7F0", fontFamily: "serif",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "Bosque mágico", names: "Luca — Hadas y duendes", date: "2026-09-14T15:00:00", subtitle: "Musgo, madera y magia", imageUrl: "https://loremflickr.com/800/600/baby?lock=14", style: { backgroundImage: "https://loremflickr.com/800/600/baby?lock=14", backgroundOverlay: "rgba(245,247,240,0.82)", padding: "48px 20px", borderRadius: "16px" } },
  ...
  },
  {
    ...
    category: "babyshower",
    thumbnailUrl: "https://loremflickr.com/800/600/baby?lock=15",
    previewUrl: "https://loremflickr.com/1200/800/baby?lock=15",
    active: true,
    createdAt: Date.now() + 25,
    builderConfig: baseBuilder({
      primaryColor: "#C97A8E", background: "#FFF5F8", fontFamily: "serif",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "Dulce espera", names: "Isabella — Princesa", date: "2026-07-20T16:00:00", subtitle: "Moños, perlas y amor", imageUrl: "https://loremflickr.com/800/600/baby?lock=16", style: { background: "#FFFFFF", textColor: "#8A4A5E", border: "1px solid #F5D6E0", padding: "40px 20px", borderRadius: "20px" } },
        { id: "ca", type: "carousel", visible: true, images: [{ url: "https://loremflickr.com/800/600/baby?lock=17" }] },
  ...
  // ==================== BAUTIZO - 6 profesionales ====================
  {
    ...
    category: "bautizo",
    thumbnailUrl: "https://loremflickr.com/800/600/baptism?lock=1",
    previewUrl: "https://loremflickr.com/1200/800/baptism?lock=1",
    active: true,
    createdAt: Date.now() + 30,
    builderConfig: baseBuilder({
      primaryColor: "#6B7A90", background: "#F8FAFF", fontFamily: "serif",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "Ángel de luz", names: "Gabriel — Bautizo", date: "2026-06-07T12:00:00", subtitle: "Blanco, puro, bendecido", imageUrl: "https://loremflickr.com/800/600/baptism?lock=2", style: { background: "#FFFFFF", padding: "44px 20px", borderRadius: "16px", border: "1px solid #E0EAF5" } },
  ...
  },
  {
    ...
    category: "bautizo",
    thumbnailUrl: "https://loremflickr.com/800/600/baptism?lock=3",
    previewUrl: "https://loremflickr.com/1200/800/baptism?lock=3",
    active: true,
    createdAt: Date.now() + 31,
    builderConfig: baseBuilder({
      primaryColor: "#8B7A5A", background: "#FFFEFB", fontFamily: "serif",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "Mi Bautizo", names: "Sofía Victoria", date: "2026-07-11T11:00:00", subtitle: "Fe, familia y tradición", imageUrl: "https://loremflickr.com/800/600/baptism?lock=4" },
        { id: "cd", type: "countdown", visible: true, targetDate: "2026-07-11T11:00:00", label: "Día sagrado" },
        { id: "ca", type: "carousel", visible: true, images: [{ url: "https://loremflickr.com/800/600/baptism?lock=5" }] },
  ...
  },
  {
    ...
    category: "bautizo",
    thumbnailUrl: "https://loremflickr.com/800/600/baptism?lock=6",
    previewUrl: "https://loremflickr.com/1200/800/baptism?lock=6",
    active: true,
    createdAt: Date.now() + 32,
    builderConfig: baseBuilder({
      primaryColor: "#7BA3C4", background: "#FFF9F0", fontFamily: "sans",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "Acuarela de fe", names: "Luna — Colores de bendición", date: "2026-08-09T12:30:00", subtitle: "Pinceladas de amor", imageUrl: "https://loremflickr.com/800/600/baptism?lock=7", style: { background: "linear-gradient(135deg,#FFF9F0,#EAF4FF)", padding: "40px 20px", borderRadius: "20px" } },
  ...
  },
  {
    ...
    category: "bautizo",
    thumbnailUrl: "https://loremflickr.com/800/600/baptism?lock=8",
    previewUrl: "https://loremflickr.com/1200/800/baptism?lock=8",
    active: true,
    createdAt: Date.now() + 33,
    builderConfig: baseBuilder({
      primaryColor: "#4A5A8A", background: "#F8F5FF", fontFamily: "serif",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "Mi Principito", names: "Leo — Corona y amor", date: "2026-05-16T12:00:00", subtitle: "Pequeño rey, gran bendición", imageUrl: "https://loremflickr.com/800/600/baptism?lock=9", style: { backgroundImage: "https://loremflickr.com/800/600/baptism?lock=9", backgroundOverlay: "rgba(248,245,255,0.78)", padding: "44px 20px", borderRadius: "16px" } },
  ...
  },
  {
    ...
    category: "bautizo",
    thumbnailUrl: "https://loremflickr.com/800/600/baptism?lock=10",
    previewUrl: "https://loremflickr.com/1200/800/baptism?lock=10",
    active: true,
    createdAt: Date.now() + 34,
    builderConfig: baseBuilder({
      primaryColor: "#B9972B", background: "#FFFEF0", fontFamily: "serif",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "Luz divina", names: "Alana — Que tu luz brille", date: "2026-09-20T11:30:00", subtitle: "Dorado, luz y fe", imageUrl: "https://loremflickr.com/800/600/baptism?lock=11", style: { background: "#FFFEF0", textColor: "#6B5A1A", border: "1px solid #F5E6A0", padding: "40px 20px", borderRadius: "16px" } },
  ...
  },
  {
    ...
    category: "bautizo",
    thumbnailUrl: "https://loremflickr.com/800/600/baptism?lock=12",
    previewUrl: "https://loremflickr.com/1200/800/baptism?lock=12",
    active: true,
    createdAt: Date.now() + 35,
    builderConfig: baseBuilder({
      primaryColor: "#9A6B7A", background: "#FFF6FA", fontFamily: "serif",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "Flores de bendición", names: "Mila — Florece con fe", date: "2026-10-11T12:00:00", subtitle: "Pétalos y oración", imageUrl: "https://loremflickr.com/800/600/baptism?lock=13", style: { backgroundImage: "https://loremflickr.com/800/600/baptism?lock=13", backgroundOverlay: "rgba(255,246,250,0.75)", padding: "48px 20px", borderRadius: "20px" } },
        { id: "ca", type: "carousel", visible: true, images: [{ url: "https://loremflickr.com/800/600/baptism?lock=14" }, { url: "https://loremflickr.com/800/600/baptism?lock=15" }] },
  ...
  // ==================== CORPORATIVO - 6 profesionales ====================
  {
    ...
    thumbnailUrl: "https://loremflickr.com/800/600/corporate?lock=1",
    previewUrl: "https://loremflickr.com/1200/800/corporate?lock=1",
    active: true,
    createdAt: Date.now() + 40,
    builderConfig: baseBuilder({
      primaryColor: "#2563EB", background: "#F0F6FF", fontFamily: "sans",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "Tech Summit 2026", names: "Innovación sin límites", date: "2026-10-22T09:00:00", subtitle: "Keynotes, demos, networking", imageUrl: "https://loremflickr.com/800/600/corporate?lock=2", style: { background: "#FFFFFF", border: "1px solid #DBEAFE", padding: "32px 20px", borderRadius: "12px" } },
  ...
  },
  {
    ...
    category: "corporativo",
    thumbnailUrl: "https://loremflickr.com/800/600/corporate?lock=3",
    previewUrl: "https://loremflickr.com/1200/800/corporate?lock=3",
    active: true,
    createdAt: Date.now() + 41,
    builderConfig: baseBuilder({
      primaryColor: "#0F172A", background: "#F8FAFC", fontFamily: "serif",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "Gala Anual", names: "Premios Empresariales 2026", date: "2026-11-28T20:00:00", subtitle: "Celebrando la excelencia", imageUrl: "https://loremflickr.com/800/600/corporate?lock=4", style: { background: "#0F172A", textColor: "#F8FAFC", padding: "48px 20px", borderRadius: "12px" } },
  ...
  },
  {
    ...
    category: "corporativo",
    thumbnailUrl: "https://loremflickr.com/800/600/corporate?lock=5",
    previewUrl: "https://loremflickr.com/1200/800/corporate?lock=5",
    active: true,
    createdAt: Date.now() + 42,
    builderConfig: baseBuilder({
      primaryColor: "#7C3AED", background: "#FAF5FF", fontFamily: "sans",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "Producto X — Reveal", names: "El futuro es ahora", date: "2026-09-10T18:30:00", subtitle: "Demo en vivo, cóctel y prensa", imageUrl: "https://loremflickr.com/800/600/corporate?lock=6", style: { background: "linear-gradient(135deg,#FAF5FF,#F5F3FF)", padding: "40px 20px", borderRadius: "20px", border: "1px solid #E9D5FF" } },
        { id: "cd", type: "countdown", visible: true, targetDate: "2026-09-10T18:30:00", label: "Reveal" },
        { id: "ca", type: "carousel", visible: true, images: [{ url: "https://loremflickr.com/800/600/corporate?lock=7" }] },
  ...
  },
  {
    ...
    category: "corporativo",
    thumbnailUrl: "https://loremflickr.com/800/600/corporate?lock=8",
    previewUrl: "https://loremflickr.com/1200/800/corporate?lock=8",
    active: true,
    createdAt: Date.now() + 43,
    builderConfig: baseBuilder({
      primaryColor: "#047857", background: "#ECFDF5", fontFamily: "sans",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "Networking Cocktail", names: "Conecta & Crece", date: "2026-08-20T18:00:00", subtitle: "Cóctel ejecutivo, pitch 1-min", imageUrl: "https://loremflickr.com/800/600/corporate?lock=9" },
  ...
  },
  {
    ...
    category: "corporativo",
    thumbnailUrl: "https://loremflickr.com/800/600/corporate?lock=10",
    previewUrl: "https://loremflickr.com/1200/800/corporate?lock=10",
    active: true,
    createdAt: Date.now() + 44,
    builderConfig: baseBuilder({
      primaryColor: "#334155", background: "#F1F5F9", fontFamily: "serif",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "Reunión Anual", names: "Grupo Invify 2026", date: "2026-12-12T10:00:00", subtitle: "Resultados y visión 2027", imageUrl: "https://loremflickr.com/800/600/corporate?lock=11", style: { background: "#FFFFFF", border: "1px solid #E2E8F0", padding: "32px 20px", borderRadius: "8px" } },
  ...
  },
  {
    ...
    category: "corporativo",
    thumbnailUrl: "https://loremflickr.com/800/600/corporate?lock=12",
    previewUrl: "https://loremflickr.com/1200/800/corporate?lock=12",
    active: true,
    createdAt: Date.now() + 45,
    builderConfig: baseBuilder({
      primaryColor: "#EA580C", background: "#FFF7ED", fontFamily: "sans",
      modules: [
        { id: "hdr", type: "header", visible: true, title: "Startup Pitch Night", names: "Demo Day Invify", date: "2026-07-30T18:00:00", subtitle: "Ideas que cambian el mundo", imageUrl: "https://loremflickr.com/800/600/corporate?lock=13", style: { background: "linear-gradient(135deg,#FFF7ED,#FFEDD5)", padding: "36px 20px", borderRadius: "16px" } },
        { id: "cd", type: "countdown", visible: true, targetDate: "2026-07-30T18:00:00", label: "Demo Day" },
        { id: "ca", type: "carousel", visible: true, images: [{ url: "https://loremflickr.com/800/600/corporate?lock=14" }] },
